...
const services = [
    {
        title: "Banho e Tosa",
        description: "Inclui banho com produtos especificos para o tipo de pelagem e pele do animal, corte de unhas, limpeza das orelhas e tosa personalizadas (higiênicas ou estilizada).",
        duration: "1h",
        price: "R$50",
        icon: <Scissors />,
    ...
    {
        title: "Táxi Pet",
        description: "Serviço de transporte para levar e buscar os petss no petshop, clínicas veterinárias ou outros locais. Ideal para tutores que não têm tempo ou transporte adequado para locomover os animais.",
        duration: "2h",
        price: "R$80",
        icon: <CarTaxiFront />,
        linkText: 'Olá, vi no site sobre Banho e tosa gostaria de mais informações.'
    ...
    return (
        ...
        <section className="bg-white py-16">
            <div className="container mx-auto px-4" data-aos="fade-right"
                ...
                <h2 className="text-4xl font-bold mb-12" data-aos="fade-left" data-aos-delay="300">Serviços</h2>
                                ...
                                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex-col">
                                        ...
                                        <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                            ...
                                            <a
                                                target='_blank'
                                                href={`https://wa.me/12547890?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`}
                                                className='flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 rounded-md duration-300'
                                            >
                                                <WhatsappLogoIcon className='w-5 h-5' select-none />
                                                Entrar em contato
                                            </a>
